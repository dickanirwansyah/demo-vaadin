...
@ServerClass("com.gmail.muhammad.ui.views.orderedit.OrderEditViewDesign")
@AutoGenerated
public class OrderEditViewDesignElement extends VerticalLayoutElement {
	...
	public OrderHistoryElement getHistory() {
		return $(com.gmail.muhammad.ui.views.orderedit.OrderHistoryElement.class).id("history");
	}
